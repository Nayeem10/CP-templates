...
private:
    ...
    void normalize() {value %= M; if (value < 0) value += M;}
...
public:
    ...
    mint& operator=(int value) {this->value = value; normalize(); return *this;}
    ...
    mint& operator*=(const mint& other) {value *= other.value; normalize(); return *this;}
    mint& operator*=(int other) {value *= other; normalize(); return *this;}
    mint& operator/=(const mint& other) {value = (value * mpow(other.value, -1)); normalize(); return *this;}
    mint& operator/=(int other) {value = (value * mpow(other, -1)); normalize(); return *this;}
